                ...
                <div class="card card-dark">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/role/add') }}" class="btn btn-tool">
                                ...
                                <table id="list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($value->status)
                                                <a href="{{ url('admin/role/status/'.$value->id) }}"
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/role/edit/'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item"
                                                                data-toggle="modal" data-target="#role-modal{{$value->id }}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="role-modal{{$value->id }}" style="display: none;"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <a type="button"
                                                            href="{{ url('admin/role/delete/'.$value->id) }}"
