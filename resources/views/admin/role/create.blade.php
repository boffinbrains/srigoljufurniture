                    ...
                    <form id="role_form" enctype="multipart/form-data" autocomplete="off" novalidate>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2" name="permissions" id="permissions" multiple="multiple" data-placeholder="Assign Permissions"
                                    style="width: 100%;">
                            ...
                            <div class="card-footer pl-0">
                                <button class="btn btn-primary" id="role_form_btn">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
...
$(document).ready(function() {
    ...
    validator('#role_form', '#role_form_btn', "{{ url('admin/role/create') }}",
        role_form_data);
});
</script>
@endsection