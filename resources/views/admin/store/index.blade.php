                ...
                <div class="card card-dark">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/store/add') }}" class="btn btn-tool">
                                ...
                                <table id="list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('images/store/'.$value->image) }}" width="50px"
                                                    alt="{{$value->title}}">
                                            </td>
                                            <td>
                                                @if ($value->status)
                                                <a href="{{ url('admin/store/status/'.$value->id) }}"
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/store/edit/'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item"
                                                                data-toggle="modal"
                                                                data-target="#store-modal{{$value->id }}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="store-modal{{$value->id }}" style="display: none;"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <a type="button"
                                                            href="{{ url('admin/store/delete/'.$value->id) }}"
