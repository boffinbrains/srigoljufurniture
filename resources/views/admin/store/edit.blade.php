                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <img width="100px" class="mt-4" src="{{ asset('images/store/'.$data->image) }}"
                                            alt="{{ $data->title }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="description"
                                            ...
                                            rows="7">{{ $data->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button class="btn btn-primary" id="store_form_btn">Update</button>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    validator('#store_form', '#store_form_btn', "{{ url('admin/store/update') }}", store_form_data, id =
        "{{$data->id}}");
});
</script>
@endsection