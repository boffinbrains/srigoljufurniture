                ...
                <div class="card card-dark">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/brand/add') }}" class="btn btn-tool">
                                ...
                                <table id="list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('images/brand/'.$value->image) }}" width="50px"
                                                    alt="{{$value->title}}">
                                            </td>
                                            <td>
                                                @if ($value->status)
                                                <a href="{{ url('admin/brand/status/'.$value->id) }}"
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/brand/edit/'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item"
                                                                data-toggle="modal" data-target="#brand-modal{{$value->id }}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="brand-modal{{$value->id }}" style="display: none;"
                                            aria-hidden="true">
