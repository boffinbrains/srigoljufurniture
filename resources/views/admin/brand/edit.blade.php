                    ...
                    <form id="brand_form" enctype="multipart/form-data" autocomplete="off" novalidate>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <img width="100px" class="mt-4" src="{{ asset('images/brand/'.$data->image) }}" alt="{{ $data->title }}">
                            </div>
                        </div>
                        <div class="card-footer">
                            <button class="btn btn-primary" id="brand_form_btn">Update</button>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    validator('#brand_form', '#brand_form_btn', "{{ url('admin/brand/update') }}", brand_form_data, id="{{$data->id}}");
});
</script>
@endsection