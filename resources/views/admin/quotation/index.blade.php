                ...
                <div class="card card-dark">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ url('admin/quotation/add') }}" class="btn btn-tool">
                                ...
                                <table id="list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                echo get_bank_name($value->bank_id);
                                                @endphp
                                            </td>
                                            <td>
                                                @php
                                                echo get_username($value->made_by);
                                                @endphp
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/quotation/edit/'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item"
                                                                data-toggle="modal"
                                                                data-target="#quotation-modal{{$value->id }}">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item btn btn-primary"
                                                                href="{{ URL::to('/admin/quotation/createPdf/'.$value->id) }}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="quotation-modal{{$value->id }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <a type="button"
                                                            href="{{ url('admin/quotation/delete/'.$value->id) }}"
