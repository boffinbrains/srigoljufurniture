                ...
                <div class="card card-dark">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/product/add') }}" class="btn btn-tool">
                                ...
                                <table id="list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                echo get_category_name($value->category_id);
                                                @endphp
                                            </td>
                                            <td>
                                                {{$value->btitle}}
                                            ...
                                            <td>
                                                @if ($value->status)
                                                <a href="{{ url('admin/product/status/'.$value->id) }}"
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/product/edit/'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/product/gallery/P'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item"
                                                                data-toggle="modal"
                                                                data-target="#product-modal{{$value->id }}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="product-modal{{$value->id }}" style="display: none;"
                                            aria-hidden="true">
