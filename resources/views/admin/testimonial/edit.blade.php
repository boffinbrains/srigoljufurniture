                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="toggle" id="toggle" class="form-control">
                                    ...
                                    <option value="video" {{ $data->video!='' ? 'selected' : '' }}>Video</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group image-toggle">
                                ...
                                src="{{ asset('images/testimonial/'.$data->image) }}"
                                alt="{{ $data->name }}">
                                @endif
                            </div>
                            <div class="form-group">
                                <label for="review">Review*</label>
                                <textarea class="form-control" id="review" rows="7"
                                    name="review">{{ $data->review }}</textarea>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button class="btn btn-primary" id="testimonial_form_btn">Update</button>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    validator('#testimonial_form', '#testimonial_form_btn', "{{ url('admin/testimonial/update') }}",
        about_form_data, id = "{{$data->id}}");
});
