                ...
                <div class="card card-dark">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ url('admin/testimonial/add') }}" class="btn btn-tool">
                                ...
                                <table id="list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($value->image)
                                                <img src="{{ asset('images/testimonial/'.$value->image) }}" width="50px"
                                                alt="{{$value->name}}">
                                                @else
                                                NULL
                                                @endif
                                            ...
                                            <td>
                                                @if ($value->status)
                                                <a href="{{ url('admin/testimonial/status/'.$value->id) }}"
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-start">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ url('admin/testimonial/edit/'.$value->id) }}">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item"
                                                                data-toggle="modal"
                                                                data-target="#testimonial-modal{{$value->id }}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="testimonial-modal{{$value->id }}" style="display: none;"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <a type="button"
                                                            href="{{ url('admin/testimonial/delete/'.$value->id) }}"
