                    ...
                    <form id="permission_form" enctype="multipart/form-data" autocomplete="off" novalidate>
                        <div class="card-body">
                            ...
                            <div class="card-footer pl-0">
                                <button class="btn btn-primary" id="permission_form_btn">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
...
$(document).ready(function() {
    ...
    validator('#permission_form', '#permission_form_btn', "{{ url('admin/permission/update') }}",
        permission_form_data, id = "{{$data->id}}");
});
</script>
@endsection