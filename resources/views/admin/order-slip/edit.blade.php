                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="tel" class="form-control"
                                                                    ...
                                                                    value="{{$data->customer_number}}" maxlength="10">
                                                                        ...
                                                                        @if(count($item)>0)
                                                                            ...
                                                                            <tr class="line_items">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div id="preview">
                                                                                        <img src="{{ asset('images/order-slip/'.$items->item_image) }}"
                                                                                            alt="{{ $items->item_name }}" width="100px">
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text"
                                                                                ...
                                                                                <td>
                                                                                     <input type="hidden"
                                                                                        ...
                                                                                        value="{{ $items->height }}">
                                                                                    <button
                                                                                        class="btn btn-danger row-remove" disabled>
                                                                                        <i class="bi bi-x"></i>
                                                                                    </button>
                                                                                </td>
                                                                            </tr>
...
$(document).ready(function() {
    ...
    validator('#order_slip_form', '#order_slip_form_btn', "{{ url('admin/order-slip/update') }}",
        order_slip_form_data, id = "{{$data->id}}");
    ...
    validator('#order_slip_items_form', '#order_slip_items_form_btn',
        "{{ url('admin/order-slip/updateItems') }}",
        order_slip_items_form_data, id = "{{$data->id}}", true);
});
