                    ...
                    <form id="certificate_form" enctype="multipart/form-data" autocomplete="off" novalidate>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <img width="100px" class="mt-4" src="{{ asset('images/certificate/'.$data->image) }}" alt="{{ $data->title }}">
                            </div>
                        </div>
                        <div class="card-footer">
                            <button class="btn btn-primary" id="certificate_form_btn">Update</button>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    validator('#certificate_form', '#certificate_form_btn', "{{ url('admin/certificate/update') }}", certificate_form_data, id="{{$data->id}}");
});
</script>
@endsection